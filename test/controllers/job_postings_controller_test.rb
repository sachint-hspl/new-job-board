...
class JobPostingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create job_posting" do
    assert_difference("JobPosting.count") do
      post job_postings_url, params: { job_posting: { description: @job_posting.description, job_type: @job_posting.job_type, location: @job_posting.location, salary_range: @job_posting.salary_range, title: @job_posting.title, user_id: @job_posting.user_id } }
    end
  ...
  test "should update job_posting" do
    patch job_posting_url(@job_posting), params: { job_posting: { description: @job_posting.description, job_type: @job_posting.job_type, location: @job_posting.location, salary_range: @job_posting.salary_range, title: @job_posting.title, user_id: @job_posting.user_id } }
